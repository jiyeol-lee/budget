					...
					>
						...
						<td class="px-3 py-2">
							<div class="flex items-center gap-2">
								...
								/>
								{#if item.expected_expense_id}
									<span
										class="bg-success-dark text-success-light inline-flex items-center rounded px-2 py-0.5 text-xs font-medium"
										title="Matched with expected expense"
									>
										Matched
									</span>
								{/if}
