...
func NewRouter(h *Handlers) *http.ServeMux {
	...
	// Expected Expenses routes (renamed from /api/expenses)
	...
	mux.HandleFunc("GET /api/actual-expenses/next-receipt-number", h.ActualExpense.GetNextReceiptNumber)
