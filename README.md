...
| Dashboard | Receipt Processing | Expense List |
|-----------|-------------------|--------------|
| ![Dashboard](docs/screenshots/dashboard.png) | ![Receipt](docs/screenshots/receipt.png) | ![Expenses](docs/screenshots/expenses.png) |
-->
